...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Website laten maken Utrecht | Elly Apps',
    description: 'Website laten maken in Utrecht? Elly Apps bouwt professionele websites voor Utrechtse MKB-bedrijven. Lokale SEO en volledig ontzorgd. Vanaf €49/maand.',
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        <div>
          <p className="text-sm text-[#E53E3E] font-medium mb-2">Utrecht</p>
